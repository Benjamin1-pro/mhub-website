...
import './Pagination.css'; // Import your CSS file (optional)
    ...
    <div>
      {data && (
        <ul className="pagination justify-content-center pagination-sm">
          <li
            className={`page-item ${!data.prev_page_url && showDisabled ? 'disabled' : ''}`}
          >
            <a
              href="#"
              className="page-link"
          ...
          <li
            className={`page-item ${!data.next_page_url && showDisabled ? 'disabled' : ''}`}
          >
            <a
              href="#"
              className="page-link"
